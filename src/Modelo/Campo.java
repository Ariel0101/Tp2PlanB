...
public class Campo implements Reiniciable {
    ...
    protected void destruir(CartaMonstruo unMonstruo) {
    ...
    protected void colocarCarta(CartaMagica carta){
    ...
    protected void agregarMonstruo(CartaMonstruo carta) {
    ...
    protected ListaMonstruos listaMonstruos(){
